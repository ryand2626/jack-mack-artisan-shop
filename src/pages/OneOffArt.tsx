                ...
                {artPieces.map((piece) => (
                  <Card key={piece.id} className="group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 bg-nature-sage border-nature-moss/20 rounded-xl overflow-hidden">
                    <div className="relative">
                      <div className="h-80 w-full flex items-center justify-center relative overflow-hidden bg-gray-50">
                        {piece.image_url ? (
                          <img 
                            src={piece.image_url} 
                            alt={piece.title}
                    ...
                    <CardContent className="p-6">
                      ...
                      <p className="text-nature-charcoal/60 mb-3">{piece.wood_type || 'Handcrafted Wood'}</p>
                      <div className="flex justify-between items-center">
                        <span className="text-2xl font-bold text-nature-moss">

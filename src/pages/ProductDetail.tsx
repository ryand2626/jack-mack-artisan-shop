            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="flex items-center gap-4 mb-6">
                  <span className="text-3xl font-bold text-nature-moss">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {product.wood_type && (
                  <div>
                    ...
                    <p className="text-nature-charcoal/70">{product.wood_type}</p>
                  </div>
                )}
                <div>
                  <h4 className="font-semibold text-nature-forest mb-2">Category</h4>
                  <p className="text-nature-charcoal/70 capitalize">{product.category?.replace('-', ' ')}</p>
                </div>
                <div>
                  <h4 className="font-semibold text-nature-forest mb-2">Status</h4>
                  <p className="text-nature-charcoal/70 capitalize">{product.stock_status}</p>
                </div>
              </div>
